...
| [USBToolBox.kext](https://github.com/USBToolBox/kext/releases) | kext for USB port |



(tool ([opens new window]([https://github.com/USBToolBox/kext](https://github.com/USBToolBox/tool/releases)))and kext ())
